...
def config():
    ...
    datasets_legitimate = dict(train=['dataset/SciARK.json'], dev=[], test=['legitimate_abstracts.json'])
    datasets_fraudulent = dict(train=['dataset/SciARK.json'], dev=[], test=['fraudulent_abstracts.json'])
